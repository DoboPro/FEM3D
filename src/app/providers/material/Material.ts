...
export class Material {
  ...
  constructor(
    ...
    this.matrix = null; // 応力 - 歪マトリクス
  }

  // 平面応力問題の応力 - 歪マトリクスを作成する
  ...
  public matrixShell(): number[][] {
    ...
    return [
      ...
      [s2, coef, 0, 0, 0],
      [0, 0, this.gg, 0, 0],
      [0, 0, 0, this.KS_RECT * this.gg, 0],
      [0, 0, 0, 0, this.KS_RECT * this.gg],
    ];
  }
